...
namespace ConverterProgram
{
    class Program
    {
        ...
        public static bool huvudMeny()
        {
            ...
            Console.WriteLine("Tryck 1 för att hantera elektricitet.  ");
        ...
        static bool mainMenyEl()
        {
            ...
            Console.WriteLine("Tryck övrig siffra för att gå tillbaka ");
            Console.Write("\n\nVälj ett alternativ ");
        ...
        static bool mainMenyHastighet()
        {
            ...
            Console.WriteLine("Tryck övrig siffra för att återvända till huvudmenyn");
            Console.Write("\n\nVälj ett alternativ ");
        ...
        static bool mainMenyLiquid()
        {
            ...
            Console.WriteLine("Tryck på övrig siffra för att återvända till menyn.");
            Console.Write("\n\nVälj ett alternativ ");
        ...
        public static bool mainMenyTemp()
        {
            ...
            Console.WriteLine("Klicka övrig siffra för att återgå till huvudmeny");
            Console.Write("\n\nVälj ett alternativ ");
        ...
        static bool mainMenyTid()
        {
            ...
            Console.WriteLine("Klicka övrig siffra för att återvända till huvudmenyn.");
            Console.Write("\n\nVälj ett alternativ ");
        ...
        static bool mainMenyArea()
        {
            ...
            Console.WriteLine("Tryck övrig siffra för att återvända till menyn.");
